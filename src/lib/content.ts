  ...
  experiments: [
    {
      ...
      description:
        "Uso diario de Claude, Cursor, GitHub Copilot, Replit y Lovable para prototipar, debuggear y lanzar automatizaciones con sus propias manos — no solo para escribir specs.",
    },
  ],
};
...
export const about = {
  bio: [
    "Senior Technical Product Manager with 5+ years building and scaling B2B and B2C SaaS products in integration-heavy, partner-facing environments. I lead API-based integrations end to end — translating technical and business requirements into clear specs, then orchestrating engineering, data, operations and external partners to ship them.",
    "I'm a daily user of AI tooling — Claude, Cursor, GitHub Copilot — to prototype, debug and ship automations myself, not just write specs and hand them off. Discovery is not a phase, it's a habit, and the best roadmap is the one that kills the most bad ideas early.",
